...
export const CREATE_VOLUNTEER_RULES = [
...

  {
    ...
    validate: (value) => {
      if (!value || typeof value !== "string") {
        return "CPF ou RG não fornecido";
      }
...

  {
    ...
    validatorErrorMessage:
      "Telefone principal inválido ou não fornecido",
  },

  {
    ...
    validator: "phone",
    validatorErrorMessage:
      "Telefone secundário inválido ou não fornecido",
  },

  {
    ...
    validate: (value) => {
      ...
      if (typeof value !== "boolean") {
        return "Campo hasWhatsApp deve ser booleano";
      }
...

  {
    ...
    validate: (value) => {
      ...
      if (typeof value !== "boolean") {
        return "Campo hasWhatsAppSecondary deve ser booleano";
      }
...

  {
    ...
    validate: (value) => {
      ...
      if (
        ...
        return "Número residencial inválido";
      }
...

  {
    ...
    validator: "state",
    validatorErrorMessage:
      "Estado inválido (deve conter 2 caracteres)",
  },
];

/** @type {import("../middlewares/validator/validator.js").ValidationRule[]} */
export const EDIT_VOLUNTEER_BODY_RULES =
  CREATE_VOLUNTEER_RULES.map((rule) => ({
    ...rule,
    required: false,
  }));
    ...
    validate: (value, target) => {
      ...
      if (sortKey === "name") {
        ...
        if (!["asc", "desc"].includes(sortType)) {
          return "Tipo de ordenação não compatível";
        }
      } else {
        return "Chave de ordenação inválida";
      }
